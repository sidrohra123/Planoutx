...
var express = tslib_1.__importStar(__webpack_require__(61));
var cors = tslib_1.__importStar(__webpack_require__(131));
var compression = tslib_1.__importStar(__webpack_require__(133));
var path_1 = __webpack_require__(1);
exports.app = express();
exports.app.use(compression());
exports.app.use(cors());
var DIST_FOLDER = path_1.join(process.cwd(), 'www');
...
Zone.__load_patch('node_timers', function (global, Zone) {
    ...
    try {
        var timers = __webpack_require__(59);
...
var bytes = __webpack_require__(76)
var createError = __webpack_require__(7)
var iconv = __webpack_require__(33)
...
module.exports = {
    ...
    'big5hkscs': {
        type: '_dbcs',
        table: function() { return __webpack_require__(35).concat(__webpack_require__(92)) },
...
var accepts = __webpack_require__(55)
var Buffer = __webpack_require__(22).Buffer
var bytes = __webpack_require__(134)
var compressible = __webpack_require__(135)
var debug = __webpack_require__(0)('compression')
var onHeaders = __webpack_require__(138)
var vary = __webpack_require__(29)
var zlib = __webpack_require__(37)
